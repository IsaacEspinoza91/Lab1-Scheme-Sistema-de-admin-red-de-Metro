...
(line-section-length l1 "San Pablo" "Las Rejas")
(line-section-length l3 "Hospitales" "Plaza de Armas")
(line-section-length l3 "Plaza de Armas" "Hospitales")

(line-cost l1)
(line-cost l2)
(line-cost l3)

(line-section-cost l1 "San Pablo" "Las Rejas")
(line-section-cost l1 "Universidad de Santiago de Chile" "Baquedano")
(line-section-cost l3 "Lo Cruzat" "Parque Almagro")
...
(define t3 (train 3 "CAF" "100 R.E." 70  2 pc11a pc11 pc12 pc13 pc14 pc15 pc16 pc17))
(define t4 (train 4 "CAF" "100 R.E." 70  2 pc1 pc2 pc3))
(define t5 (train 5 "CAF" "100 R.E." 70  2 pc0 pc5 pc9 pc12 pc17))
(define t6 (train 6 "CAF" "UIC 60 ASCE" 60 2 pc1 pc2 pc6 pc4))
...
(define t0e (train-add-car t0d pc9 4))

(define t1a (train-remove-car t1 0))
(define t1b (train-remove-car t1 2))
(define t1c (train-remove-car t1b 3))
...
(define sw0f1 (subway-add-driver sw0e d2))
...
(define sw0g (subway-rise-section-cost sw0f (lambda (c) (* c 1.3))))
(define sw0h (subway-rise-section-cost sw0g (lambda (c) (* c 1.05))))
(define sw0i (subway-rise-section-cost sw0f (lambda (c) (* c 0.9))))
