...
(provide section section? get-distance-section)

;TDA section, abstraccion de una seccion/enlace/tramo entre dos estaciones de metro como una lista de elementos
;Representacion: lista con elementos (estacion1 - estacion2 - distancia entre estaciones (real positivo) - costo (real no negativo))
